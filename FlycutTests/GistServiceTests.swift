...
final class GistServiceTests: XCTestCase {
    ...
    func testCreateGistPersistsGistRecord() async throws {
        ...
        let records = try container.mainContext.fetch(FetchDescriptor<FlycutSchemaV1.GistRecord>())
    ...
    func testDeleteGistCallsAPIAndRemovesRecord() async throws {
        ...
        let remaining = try context.fetch(FetchDescriptor<FlycutSchemaV1.GistRecord>())
