...
/// Displays the history of GitHub Gists created from Clipsmith.
///
...
struct GistHistoryView: View {
    ...
    @Query(sort: \ClipsmithSchemaV1.GistRecord.createdAt, order: .reverse)
    private var gistHistory: [ClipsmithSchemaV1.GistRecord]
