...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        logger.info("Flycut launched — accessibility trusted: \(self.accessibilityMonitor.isTrusted, privacy: .public)")
        ...
        gistService = GistService(modelContext: FlycutApp.sharedModelContainer.mainContext)
        ...
        _ = try? mainContext.fetchCount(FetchDescriptor<FlycutSchemaV1.Clipping>())
        ...
        //    skips that cycle and doesn't re-capture Flycut's own paste output.
