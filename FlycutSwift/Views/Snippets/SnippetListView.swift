...
struct SnippetListView: View {
    ...
    @Query(sort: \FlycutSchemaV1.Snippet.updatedAt, order: .reverse)
    private var allSnippets: [FlycutSchemaV1.Snippet]
    ...
    private var filteredSnippets: [FlycutSchemaV1.Snippet] {
    ...
    private var selectedSnippet: FlycutSchemaV1.Snippet? {
    ...
    @ViewBuilder
    private func snippetRow(_ snippet: FlycutSchemaV1.Snippet) -> some View {
        HStack {
    ...
    private func deleteSnippet(_ snippet: FlycutSchemaV1.Snippet) {
        setupSnippetStore()
    ...
    private func pasteSnippet(_ snippet: FlycutSchemaV1.Snippet) {
