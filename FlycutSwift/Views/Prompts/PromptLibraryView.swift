...
struct PromptLibraryView: View {
    ...
    private var filteredPrompts: [FlycutSchemaV2.PromptLibraryItem] {
    ...
    private var selectedPrompt: FlycutSchemaV2.PromptLibraryItem? {
    ...
    private func categoryBadge(for prompt: FlycutSchemaV2.PromptLibraryItem) -> some View {
    ...
    private func badgeColor(for prompt: FlycutSchemaV2.PromptLibraryItem) -> Color {
    ...
    private func detailView(for prompt: FlycutSchemaV2.PromptLibraryItem) -> some View {
    ...
    private func deletePrompt(_ prompt: FlycutSchemaV2.PromptLibraryItem) {
    ...
    private func scheduleSave(for prompt: FlycutSchemaV2.PromptLibraryItem) {
    ...
    private func revertPrompt(_ prompt: FlycutSchemaV2.PromptLibraryItem) {
    ...
    private func saveToSnippets(_ prompt: FlycutSchemaV2.PromptLibraryItem) {
        setupStores()
    ...
    private func pastePrompt(_ prompt: FlycutSchemaV2.PromptLibraryItem) {
