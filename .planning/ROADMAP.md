...
**Goal**: Keyboard-driven app launcher bezel that fuzzy-searches installed apps and launches them via NSWorkspace; a Spotlight alternative for users who only need app launching
**Depends on**: Phase 1 (bezel pattern, hotkeys, FuzzyMatcher all established)
**Success Criteria** (what must be TRUE):
...
- [x] 11-01-PLAN.md — AppEntry + AppScannerService + AppSettingsKeys + Wave 0 test stubs (scan + dedup + recordLaunch)
...
- [ ] 11-03-PLAN.md — AppDelegate wiring + KeyboardShortcuts.appLauncher + Settings toggle + menu bar button + human verify (D-07, D-10)
